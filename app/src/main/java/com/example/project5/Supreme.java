...
/**
 * A child class of pizza that represents a Supreme Pizza, with price of pizza structure.
...
public class Supreme extends Pizza{
    ...
    private static final String PIZZA_TYPE = "Supreme";

    /**
     * Default Constructor for Supreme Pizza Class and initialize ArrayList for toppings.
     */
    public Supreme(){
        Collections.addAll(toppings, Topping.SAUSAGE, Topping.PEPPERONI, Topping.HAM, Topping.GREEN_PEPPER, Topping.ONION, Topping.BLACK_OLIVE, Topping.MUSHROOM);
        super.sauce = Sauce.TOMATO;
    }

    /**
     * Overload Constructor for Supreme Pizza Class and initialize ArrayList for toppings.
     */
