...
/**
 * A child class of pizza that represents a Seafood Pizza, with price of pizza structure.
...
public class Seafood extends Pizza{
    ...
    /**
     * Default Constructor for Seafood Pizza Class and initialize ArrayList for toppings.
     */
    public Seafood(){
        Collections.addAll(toppings, Topping.SHRIMP, Topping.SQUID, Topping.CRAB_MEATS);
        super.sauce = Sauce.ALFREDO;
    }

    /**
     * Overload Constructor for Seafood Pizza Class and initialize ArrayList for toppings.
     */
    ...
    /**
     * Getter method to retrieves the type of pizza, which is "Seafood".
