...
/**
 * A child class of pizza that represents a Veggie Alfredo Pizza, with price of pizza structure.
...
public class VeggieAlfredo extends Pizza {
    ...
    private static final String PIZZA_TYPE = "Veggie Alfredo";

    /**
     * Default Constructor for Veggie Alfredo Pizza Class and initialize ArrayList for toppings.
     */
    public VeggieAlfredo(){
        Collections.addAll(toppings, Topping.MUSHROOM, Topping.ONION, Topping.GREEN_PEPPER);
        super.sauce = Sauce.ALFREDO;
    }

    /**
     * Overload Constructor for Veggie Alfredo Pizza Class and initialize ArrayList for toppings.
     */
    public VeggieAlfredo(Size size, boolean extraSauce, boolean extraCheese){
    ...
    /**
     * Getter method to retrieves the type of pizza, which is "Veggie Alfredo".
