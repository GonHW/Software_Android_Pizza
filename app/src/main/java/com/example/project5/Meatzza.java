...
/**
 * A child class of pizza that represents a Meatzza Pizza, with price of pizza structure.
...
public class Meatzza extends Pizza{
    ...
    private static final String PIZZA_TYPE = "Meatzza";

    /**
     * Default Constructor for Meatzza Pizza Class and initialize ArrayList for toppings.
     */
    public Meatzza(){
        Collections.addAll(toppings, Topping.SAUSAGE, Topping.PEPPERONI, Topping.BEEF, Topping.HAM);
        super.sauce = Sauce.TOMATO;
    }

    /**
     * Overload Constructor for Meatzza Pizza Class and initialize ArrayList for toppings.
     */
    ...
    /**
     * Getter method to retrieves the type of pizza, which is "Meatzza".
