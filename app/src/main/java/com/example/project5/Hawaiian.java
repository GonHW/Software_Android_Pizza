...
/**
 * A child class of pizza that represents a Hawaiian Pizza, with price of pizza structure.
...
public class Hawaiian extends Pizza {
    ...
    private static final String PIZZA_TYPE = "Hawaiian";

    /**
     * Default Constructor for Hawaiian Pizza Class and initialize ArrayList for toppings.
     */
    public Hawaiian(){
        Collections.addAll(toppings, Topping.PINEAPPLE, Topping.HAM);
        super.sauce = Sauce.TOMATO;
    }

    /**
     * Overload Constructor for Hawaiian Pizza Class and initialize ArrayList for toppings.
     */
    ...
    /**
     * Getter method to retrieves the type of pizza, which is "Hawaiian".
