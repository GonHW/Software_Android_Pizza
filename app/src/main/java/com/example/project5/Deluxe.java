...
/**
 * A child class of pizza that represents a Deluxe Pizza, with price of pizza structure.
...
public class Deluxe extends Pizza {
    ...
    /**
     * Default Constructor for Deluxe Pizza Class and initialize ArrayList for toppings.
     */
    public Deluxe(){
        Collections.addAll(toppings, Topping.SAUSAGE, Topping.PEPPERONI, Topping.GREEN_PEPPER, Topping.ONION, Topping.MUSHROOM);
        super.sauce = Sauce.TOMATO;
    }

    /**
     * Overload Constructor for Deluxe Pizza Class and initialize ArrayList for toppings.
     */
    ...
    /**
     * Getter method to retrieves the type of pizza, which is "Deluxe".
