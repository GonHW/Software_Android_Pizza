...
/**
 * A child class of pizza that represents a The Pig Pizza, with price of pizza structure.
...
public class ThePig extends Pizza {
    ...
    private static final String PIZZA_TYPE = "The Pig";

    /**
     * Default Constructor for The Pig Pizza Class and initialize ArrayList for toppings.
     */
    public ThePig(){
        Collections.addAll(toppings, Topping.SAUSAGE, Topping.PEPPERONI, Topping.HAM);
        super.sauce = Sauce.TOMATO;
    }

    /**
     * Overload Constructor for The Pig Pizza Class and initialize ArrayList for toppings.
     */
    public ThePig(Size size, boolean extraSauce, boolean extraCheese){
    ...
    /**
     * Getter method to retrieves the type of pizza, which is "The Pig".
